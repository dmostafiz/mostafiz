...
export default function HomepageCarousel() {
    return (
        <Box
            bgImage={'https://www.geteducated.com/wp-content/uploads/2022/01/iStock-875241826-1140x400.jpg'}
            bgRepeat="no-repeat"
            bgPosition="center"
            bgSize={`cover`}
            // bgBlendMode='hue'
        ...
        >
            <Box w='full' bgGradient='linear(to-r, #000000e3, #2d3183d4)' backdropFilter='auto' backdropBlur='6px' pb={10} pt={{ base: 3, md: 8 }}>
